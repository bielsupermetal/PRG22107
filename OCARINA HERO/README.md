...
determina o tempo exato que a nota deve ser pressionada. O jogador, por sua vez, deve buscar o número máximo de pontuação. O jogo pode acabar se 20% das notas forem perdidas. Após uma música ser concluída com sucesso, o jogador avança para a próxima música. Ao concluir as três músicas, o jogo é concluído com êxito. Se a música falhar, o jogador pode dar restart na mesma música para continuar seu progresso.
